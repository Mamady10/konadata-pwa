...
export const DEMO_ACCOUNTS = [
  ...
  },
  {
    ...
    captures: [
      ...
      { id: '31-btp-chantiers', url: '/btp/chantiers', wait: 2500 },
      { id: '32-btp-personnel', url: '/btp/personnel', wait: 2500 },
      { id: '35-btp-materiels', url: '/btp/materiels', wait: 2000 },
      { id: '33-btp-carburant', url: '/btp/carburant', wait: 2000 },
      { id: '36-btp-bons', url: '/btp/bons', wait: 2500 },
      { id: '37-btp-finances', url: '/btp/finances', wait: 2500 },
      { id: '38-btp-avancement', url: '/btp/avancement', wait: 2500 },
      { id: '34-btp-documents', url: '/btp/documents', wait: 2000 },
      { id: '39-btp-rapports', url: '/btp/rapports', wait: 2500 },
      { id: '40-btp-assignations', url: '/btp/assignations', wait: 2500 },
    ],
  },
  {
    key: 'btp_chef',
    ...
    role: 'btp_staff',
    captures: [
      { id: '41-btp-chef-dashboard', url: '/btp', wait: 2500 },
      { id: '42-btp-chef-avancement', url: '/btp/avancement', wait: 2500 },
      { id: '43-btp-chef-rapports', url: '/btp/rapports', wait: 2500 },
    ],
  },
  {
    key: 'pme',
