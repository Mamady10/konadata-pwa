...
-- Une entreprise peut gérer plusieurs boutiques. Les ventes,
-- achats, dépenses et produits peuvent être rattachés à une boutique
-- pour permettre des rapports par boutique + un rapport général.
...
-- ─── Rattachement des opérations à une boutique ──────────────
