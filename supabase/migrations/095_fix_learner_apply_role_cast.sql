-- Fix: CASE role renvoie du TEXT au lieu de app_role dans apply_to_school_as_learner / ensure_learner_profile
...
BEGIN
  ...
  SET organization_id = p_org_id,
      role = CASE
        WHEN v_profile.role = 'student'::app_role THEN 'student'::app_role
