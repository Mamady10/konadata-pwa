-- Exécuter dans Supabase SQL Editor si la migration 058 n'est pas encore appliquée
...
BEGIN
  ...
  SELECT count(*) INTO v_agents FROM ngo_survey_agent_assignments WHERE survey_id = p_survey_id;
